...
// вспомагательный клас, берет на себя создание прямоугольника и столбов
public class MovHandler {

    private  Grass frontGrass, backGrass;
    private Web web1, web2, web3;
    // скорость перемещения обьектов и просвет между вехним и нижним столбами
    public static final int MOV_SPEED = -59;
    public static final int WEB_GAP = 60;

    private GameWorld gameWorld;

    // конструктор получает позицию соднаия обьектов по оси У
    ...
    */
    ...
    // вызвываем обновление прямоугольника и реализуем его движение
